                      ...
                      <div className="flex gap-1.5 items-center">
                        {a.status === 'pending' && (
                          <>
                            <button
                              ...
                              className="text-xs px-2.5 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 flex items-center gap-1"
                            >
                            ...
                            <button
                              ...
                              className="text-xs px-2.5 py-1.5 bg-red-100 text-red-700 rounded-lg hover:bg-red-200 disabled:opacity-50 flex items-center gap-1"
                            >
                        ...
                        {a.status === 'approved' && (
                          <button
                            ...
                            className="text-xs px-2.5 py-1.5 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 flex items-center gap-1"
                          >
